...
\end{equation}
Gdzie za klasę wzięto klasę używanego woltomierza równą 0.01, zaś za rozdzielczość %Jak to ując?
\\
...
\section{Wnioski}
Otrzymane wyniki dla maksimow i minimow są tożsame dla dwoch przedziałow %Czy dla jednego?
