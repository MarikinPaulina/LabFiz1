...
Ponieważ współczynnik załamania danego ośrodka jest zależny od tejże prędkości, on także będzie się zmieniał w zależności od częstotliwości fali. W przypadku światła zawierającego
więcej niż jedną częstotliwość zostanie ono rozdzielone na pojedyńcze wiązki.
...
\begin{itemize}
  ...
  \end{equation}
  \item Kąt najmniejszego odchylenia %Oba są zasadniczo gotowe, tylko muszę je przestukać
